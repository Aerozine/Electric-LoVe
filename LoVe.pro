...
If (Flag_AnalysisType == 0)
  ...
  { Name Post_Ele; NameOfPostProcessing EleDyn_v;
    Operation {
      ...
      Print[ norm_d, OnElementsOf Domain_Ele, Name "|D| [A/m²]", File "res/dm.pos" ];
      ...
      Print[ V0, OnRegion Copper_0, Format Table, StoreInVariable $voltage,
    ...
    PostOperation{
      ...
      { Name Post_Mag; NameOfPostProcessing MQS_a_2D;
        Operation {
          ...
          Print[ R, OnRegion Copper_0, Format Table,
            SendToServer "{01Global MAG results/1Resistance", Units "Ω/m", File "res/Rinds.dat" ];
          Print[ L, OnRegion Copper_0, Format Table,
          ...
          Print[ I0, OnRegion Copper_0, Format Table, StoreInVariable $current,
